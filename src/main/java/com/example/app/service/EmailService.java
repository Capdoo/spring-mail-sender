...
public class EmailService {
    ...
    public void sendEmail(){
        ...
        simpleMailMessage.setFrom("rafael.said.dont");
        simpleMailMessage.setTo("mazher_2014@hotmail.com");
        simpleMailMessage.setSubject("Prueba envio mail simple");
        simpleMailMessage.setText("Esto es el contenido del email");
